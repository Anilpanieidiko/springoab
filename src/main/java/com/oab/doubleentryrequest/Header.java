 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.oab.com/doubleEntryRequest}channel"/>
 *         &lt;element ref="{http://www.oab.com/doubleEntryRequest}user"/>
 *         &lt;element ref="{http://www.oab.com/doubleEntryRequest}workstation"/>
 *         &lt;element ref="{http://www.oab.com/doubleEntryRequest}transactionDate"/>
 *         &lt;element ref="{http://www.oab.com/doubleEntryRequest}transactionTime"/>
 *         &lt;element ref="{http://www.oab.com/doubleEntryRequest}transactionReference"/>
 *         &lt;element ref="{http://www.oab.com/doubleEntryRequest}channelReserved"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
